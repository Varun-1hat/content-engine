...
const FIELD_GROUPS: { title: string; fields: { key: string; label: string; kind: "text" | "number" | "select" | "toggle"; options?: string }[] }[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "model_visual_video", label: "B-roll video model", kind: "text" },
      { key: "model_visual_image", label: "B-roll still model", kind: "text" },
      { key: "model_visual_product_image", label: "Product still model (sees the product photos)", kind: "text" },
